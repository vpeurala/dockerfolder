...
class CommandLineArgs
  ...
  def parse_command_line(argv)
    ...
    opt_parser = OptionParser.new do |opts|
      ...
      opts.on("-f", "--docker-file DOCKER_FILE", "The path to an already existing Dockerfile which you want to use. The file will be copied to the resulting folder of scripts. For example: --docker-file='/Users/vpeurala/templates/postgresql/Dockerfile'.") do |docker_file|
